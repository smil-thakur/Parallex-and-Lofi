import { Layer, loadSprite, makeInfiniteScroll, makeLayer, makeSprite, Sprite } from "./utils.js";



const changeNatureBtn = document.getElementById("changeNatureButton") as HTMLButtonElement;
...
async function main() {
    ...
    let [layer5, layer6, layer7, layer8]: HTMLImageElement[] = [];
    ...
    let layer5GameObj: Layer;
    let layer6GameObj: Layer;
    let layer7GameObj: Layer;
    let layer8GameObj: Layer;
